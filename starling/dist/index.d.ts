...
type LocatorStrategy = "testid" | "id" | "role" | "text" | "css";
interface FallbackLocator {
 ...
 */
declare function compile(session: Session): string;
 ...
 */
declare function mountStarling(opts?: StarlingOptions): void;
/** Unmount and clean up. Mainly for tests / explicit teardown. */
declare function unmountStarling(): void;

export { type Annotation, type FallbackLocator, type Session, type Shortcuts, type SourceLocation, type StarlingOptions, compile, mountStarling, unmountStarling };
