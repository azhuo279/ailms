...
export const MOCK_NOTIFICATIONS: WorkspaceNotification[] = [
  ...
  },
  {
    ...
    body: "Customs hold at **Laredo Cross-Dock** tied to two Gold-tier orders. SLA window closes in under 4 hours.",
    timeAgo: "9m ago",
    read: false,
  },
  {
    ...
    body: "**exc-1002** moved to the escalated queue after a second missed carrier check-in.",
    timeAgo: "24m ago",
    read: false,
  },
  {
  ...
  },
  {
    ...
    kind: "brief",
    title: "Cluster trend",
    body: "Dock congestion at **Council Bluffs** cleared. No open exceptions there for the first time today.",
    timeAgo: "1h ago",
    read: true,
  },
  {
    ...
    body: "**exc-1007** assigned to the border-ops desk with a note on the missing invoice.",
    timeAgo: "2h ago",
    read: true,
  },
];
